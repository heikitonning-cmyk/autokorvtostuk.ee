-- Extend guarded job editing with customer site selection while preserving ownership/status.

drop function if exists public.update_editable_job(
  uuid, uuid, uuid, date, time, time, text, text, uuid, text, text,
...
revoke all on function public.update_editable_job(
  uuid, uuid, uuid, uuid, date, time, time, text, text, uuid, text, text,
  numeric, numeric, numeric, numeric, numeric, text
) from public, anon;

grant execute on function public.update_editable_job(
  uuid, uuid, uuid, uuid, date, time, time, text, text, uuid, text, text,
  numeric, numeric, numeric, numeric, numeric, text
) to authenticated;
